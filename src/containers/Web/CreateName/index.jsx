...
import { getStaticData, createName } from "../../../redux/actions/nameActions";
...
class ParentProfile extends Component {
  ...
  componentWillReceiveProps(np) {
    ...
    if (np.names.newNameErrorResponse) {
      if (np.names.newNameErrorResponse.errorMessage) {
        window.scrollTo(0, 0);
        this.setState({errorResponse: np.names.newNameErrorResponse.errorMessage, successResponse: null});
      }
    }
  };
              ...
              <div className="row">
                <div className="col-md-6 offset-md-6 text-right">
                  <button className={'btn btn-save-update'}
                          onClick={this.createName}>Create</button>
...
const mapDispatchToProps = {
  getStaticData, createName, toggleLoading
};
